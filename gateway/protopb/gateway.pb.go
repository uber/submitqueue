...
var file_gateway_proto_goTypes = []any{
	...
	(*Error)(nil),                  // 6: uber.submitqueue.gateway.Error
	(*UnrecognizedQueueError)(nil), // 7: uber.submitqueue.gateway.UnrecognizedQueueError
}
var file_gateway_proto_depIdxs = []int32{
	...
	6, // 2: uber.submitqueue.gateway.UnrecognizedQueueError.error:type_name -> uber.submitqueue.gateway.Error
	1, // 3: uber.submitqueue.gateway.SubmitQueueGateway.Ping:input_type -> uber.submitqueue.gateway.PingRequest
	4, // 4: uber.submitqueue.gateway.SubmitQueueGateway.Land:input_type -> uber.submitqueue.gateway.LandRequest
	2, // 5: uber.submitqueue.gateway.SubmitQueueGateway.Ping:output_type -> uber.submitqueue.gateway.PingResponse
	5, // 6: uber.submitqueue.gateway.SubmitQueueGateway.Land:output_type -> uber.submitqueue.gateway.LandResponse
