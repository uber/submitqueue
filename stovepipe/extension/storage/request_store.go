...
// RequestStore is an interface that defines methods for managing Stovepipe trunk-validation requests in the database.
// It holds the orchestrator's working pipeline state and is owned by the orchestrator.
type RequestStore interface {
	...
	// Create creates a new request. The request must have a unique ID already assigned.
