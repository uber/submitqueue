...
// New returns a buildrunner.BuildRunner whose failure rate and build duration
// come from params, and which honors marker tokens embedded in the triggered
// headURI. The zero-value Params ask for the best-case stub: every build
// succeeds immediately. It rejects a percentage outside 0-100 and a negative
