...
const (
	...
	// TopicKeyBuild carries admitted requests from process to the build stage.
	// process publishes a BuildRequest (the request id) here; the build controller
	// consumes it and runs validation.
