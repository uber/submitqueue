...
// ProcessRequest is the payload ingest publishes to the process stage once it has
// accepted a new head: only the minted request id travels on the queue. process
// reloads the full Request from storage by this id (producer and consumer share
...
var file_process_proto_goTypes = []any{
	(*ProcessRequest)(nil), // 0: uber.stovepipe.messagequeue.ProcessRequest
}
