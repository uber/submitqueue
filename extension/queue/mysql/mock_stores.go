...
func (m *MockmessageStore) SetVisibilityTimeout(ctx context.Context, topic, partitionKey, messageID string, visibilityTimeoutMillis int64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetVisibilityTimeout", ctx, topic, partitionKey, messageID, visibilityTimeoutMillis)
	ret0, _ := ret[0].(error)
	return ret0
}

// SetVisibilityTimeout indicates an expected call of SetVisibilityTimeout.
func (mr *MockmessageStoreMockRecorder) SetVisibilityTimeout(ctx, topic, partitionKey, messageID, visibilityTimeoutMillis any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetVisibilityTimeout", reflect.TypeOf((*MockmessageStore)(nil).SetVisibilityTimeout), ctx, topic, partitionKey, messageID, visibilityTimeoutMillis)
}
...
func (m *MockpartitionLeaseStore) DiscoverAndAcquirePartitions(ctx context.Context, topic, subscriberName, consumerGroup string, leaseDurationMs int64, maxPartitions int) (int, error) {
	m.ctrl.T.Helper()
...
func (m *MockpartitionLeaseStore) DiscoverPartitions(ctx context.Context, topic string) ([]string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DiscoverPartitions", ctx, topic)
	ret0, _ := ret[0].([]string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockpartitionLeaseStoreMockRecorder) DiscoverPartitions(ctx, topic any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DiscoverPartitions", reflect.TypeOf((*MockpartitionLeaseStore)(nil).DiscoverPartitions), ctx, topic)
}
