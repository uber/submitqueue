...
import (
	...
	mysqlstorage "github.com/uber/submitqueue/extensions/storage/mysql"
)
...
// setupMySQL starts a MySQL container via Testcontainers, creates the schema,
// and returns a ready-to-use StoreFactory. All resources are cleaned up when the test finishes.
func setupMySQL(t *testing.T, log *testLogger) mysqlstorage.MySQLParameters {
	t.Helper()
	...
	return mysqlstorage.MySQLParameters{
		DSN:          dsn,
		MaxOpenConns: 5,
		MaxIdleConns: 2,
	}
