...
func NewStovepipeGatewayClient(cc grpc.ClientConnInterface) StovepipeGatewayClient {
	return &stovepipeGatewayClient{cc}
}

func (c *stovepipeGatewayClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PingResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PingResponse)
	err := c.cc.Invoke(ctx, StovepipeGateway_Ping_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedStovepipeGatewayServer must be embedded to have
...
// UnsafeStovepipeGatewayServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to StovepipeGatewayServer will
...
func RegisterStovepipeGatewayServer(s grpc.ServiceRegistrar, srv StovepipeGatewayServer) {
	// If the following call pancis, it indicates UnimplementedStovepipeGatewayServer was
	...
	s.RegisterService(&StovepipeGateway_ServiceDesc, srv)
}

func _StovepipeGateway_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StovepipeGatewayServer).Ping(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StovepipeGateway_Ping_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StovepipeGatewayServer).Ping(ctx, req.(*PingRequest))
	}
