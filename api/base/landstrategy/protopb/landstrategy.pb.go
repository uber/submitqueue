...
//
// This is the shared wire contract for land strategy, reused across SubmitQueue
// and other repo-local domains — the proto-level analog of the
// platform/base/landstrategy Go entity. Domains import it rather than redefining their own.
//
...
func (Strategy) Descriptor() protoreflect.EnumDescriptor {
	return file_landstrategy_proto_enumTypes[0].Descriptor()
}

func (Strategy) Type() protoreflect.EnumType {
	return &file_landstrategy_proto_enumTypes[0]
}
...
func (Strategy) EnumDescriptor() ([]byte, []int) {
	return file_landstrategy_proto_rawDescGZIP(), []int{0}
}

var File_landstrategy_proto protoreflect.FileDescriptor

const file_landstrategy_proto_rawDesc = "" +
	"\n" +
	...
	"\aPROMOTE\x10\x04Bx\n" +
	"&com.uber.submitqueue.base.landstrategyB\x11LandStrategyProtoP\x01Z9github.com/uber/submitqueue/api/base/landstrategy/protopbb\x06proto3"

var (
	file_landstrategy_proto_rawDescOnce sync.Once
	file_landstrategy_proto_rawDescData []byte
)

func file_landstrategy_proto_rawDescGZIP() []byte {
	file_landstrategy_proto_rawDescOnce.Do(func() {
		file_landstrategy_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_landstrategy_proto_rawDesc), len(file_landstrategy_proto_rawDesc)))
	})
	return file_landstrategy_proto_rawDescData
}

var file_landstrategy_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_landstrategy_proto_goTypes = []any{
	(Strategy)(0), // 0: uber.base.landstrategy.Strategy
}
var file_landstrategy_proto_depIdxs = []int32{
...
func init() { file_landstrategy_proto_init() }
func file_landstrategy_proto_init() {
	if File_landstrategy_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_landstrategy_proto_rawDesc), len(file_landstrategy_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_landstrategy_proto_goTypes,
		DependencyIndexes: file_landstrategy_proto_depIdxs,
		EnumInfos:         file_landstrategy_proto_enumTypes,
	}.Build()
	File_landstrategy_proto = out.File
	file_landstrategy_proto_goTypes = nil
	file_landstrategy_proto_depIdxs = nil
}
