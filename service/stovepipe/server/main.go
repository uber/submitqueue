...
func registerPrimaryControllers(
	...
	recordController := record.NewController(logger, scope, store, materializer, projectresult.NoopFactory{}, sourceControl, registry, stovepipemq.TopicKeyRecord, "stovepipe-record")
