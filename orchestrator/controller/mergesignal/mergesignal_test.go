...
func newTestController(t *testing.T) *Controller {
	...
	return NewController(logger, scope, registry, consumer.TopicMergeSignal, "orchestrator-mergesignal")
}
...
func TestNewController(t *testing.T) {
	...
	assert.Equal(t, consumer.TopicMergeSignal, controller.Topic())
