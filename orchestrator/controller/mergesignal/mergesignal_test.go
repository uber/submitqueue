...
func newTestController(t *testing.T) *Controller {
	...
	return NewController(logger, scope, registry, consumer.TopicKeyMergeSignal, "orchestrator-mergesignal")
}
...
func TestNewController(t *testing.T) {
	...
	assert.Equal(t, consumer.TopicKeyMergeSignal, controller.TopicKey())
	assert.Equal(t, "orchestrator-mergesignal", controller.ConsumerGroup())
	assert.Equal(t, "mergesignal", controller.Name())
}
