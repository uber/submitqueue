...
func (x *Validate) GetQueue() string {
	if x != nil {
		return x.Queue
	}
	return ""
...
const file_validate_proto_rawDesc = "" +
	...
	"-com.uber.submitqueue.submitqueue.messagequeueB\rValidateProtoP\x01ZAgithub.com/uber/submitqueue/submitqueue/core/messagequeue/protopbb\x06proto3"
...
var file_validate_proto_goTypes = []any{
	(*Validate)(nil), // 0: uber.submitqueue.messagequeue.Validate
}
