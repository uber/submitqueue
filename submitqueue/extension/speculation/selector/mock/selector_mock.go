...
func (m *MockSelector) Select(ctx context.Context, tree entity.SpeculationTree) ([]entity.PathDecision, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Select", ctx, tree)
...
func (mr *MockSelectorMockRecorder) Select(ctx, tree any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Select", reflect.TypeOf((*MockSelector)(nil).Select), ctx, tree)
}
