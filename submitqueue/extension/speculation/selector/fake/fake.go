...
func (s *Selector) SetDecisions(decisions ...entity.PathDecision) *Selector {
...
// Select returns the seeded decisions. The tree argument is ignored.
func (s *Selector) Select(_ context.Context, _ entity.SpeculationTree) ([]entity.PathDecision, error) {
	if s.err != nil {
		return nil, s.err
	}
