...
func (m *MockEnumerator) Enumerate(ctx context.Context, batch entity.Batch, deps []entity.Batch) ([]entity.SpeculationPath, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Enumerate", ctx, batch, deps)
	ret0, _ := ret[0].([]entity.SpeculationPath)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// Enumerate indicates an expected call of Enumerate.
func (mr *MockEnumeratorMockRecorder) Enumerate(ctx, batch, deps any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Enumerate", reflect.TypeOf((*MockEnumerator)(nil).Enumerate), ctx, batch, deps)
}
