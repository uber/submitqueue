...
func (m *MockBatchStore) Update(ctx context.Context, batch entity.Batch, oldVersion, newVersion int32) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Update", ctx, batch, oldVersion, newVersion)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (mr *MockBatchStoreMockRecorder) Update(ctx, batch, oldVersion, newVersion any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockBatchStore)(nil).Update), ctx, batch, oldVersion, newVersion)
}
