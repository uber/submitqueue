...
│
└── examples/                   # Examples (like tango/example)
    ├── README.md
...
The `tools/bazel` script is a Python implementation of Bazelisk that:
...
| Examples dir | `example/` | `examples/server/` and `examples/client/` |
