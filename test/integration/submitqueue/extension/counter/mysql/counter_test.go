...
import (
	...
	countersuite "github.com/uber/submitqueue/test/integration/submitqueue/extension/counter"
...
func (s *MySQLCounterIntegrationSuite) SetupSuite() {
	...
	s.stack = testutil.NewComposeStack(
		...
		ctx,
		"docker-compose.yml",
		"ext-submitqueue-counter-mysql", // Test context for meaningful container names
	)
	...
	schemaDir := testutil.SchemaDir("submitqueue/extension/counter/mysql/schema")
