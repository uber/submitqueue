...
import (
	...
	"github.com/uber/submitqueue/e2e_test/testutil"
...
func (s *IntegrationSuite) SetupSuite() {
	...
	mysqlContainer, db, _ := testutil.SetupMySQL(t, s.log, s.nw, "extension/storage/mysql/schema")
	testutil.ApplySchema(t, s.log, db, testutil.SchemaDir("extension/counter/mysql/schema"))
