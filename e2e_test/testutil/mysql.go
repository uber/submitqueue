...
// relativePath should be like "extension/storage/mysql/schema" or "extension/queue/sql/schema"
...
// schemaPath is the relative path to the schema directory (e.g., "extension/storage/mysql/schema").
