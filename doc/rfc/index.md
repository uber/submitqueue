...
- [Web/UI Design](web.md) - Per-domain Next.js/React BFFs with shared Node hooks, OSS example hosts, and production overlays for identity, authorization, deployment, and observability
