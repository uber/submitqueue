...
The requirement is narrower than "simulate the whole queue." Every stage — validation, conflict detection, scoring, speculation, building, merging — must be independently swappable and comparable. That constraint shapes the design more than the end-to-end case does.
