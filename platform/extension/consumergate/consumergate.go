...
type Entry interface {
	...
	//
	// Watch observes only the descriptor. It does not own or mutate the source
	// queue delivery: acknowledging, nacking, rejecting, removing, or moving the
	// delivery remains the caller's responsibility.
	//
