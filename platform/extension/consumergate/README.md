...
The gate does not own the source queue delivery and cannot acknowledge, nack, reject, remove, or move it. The caller remains responsible for queue lifecycle while a blocked entry is watched.
