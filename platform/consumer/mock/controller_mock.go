...
func (mr *MockDeliveryMockRecorder) ExtendVisibilityTimeout(ctx, durationMillis interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockControllerMockRecorder) Process(ctx, delivery interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
